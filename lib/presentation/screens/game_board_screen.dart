...
import '../widgets/static_chat_panel.dart';
          ...
          builder: (context, constraints) {
            ...
            return Stack(
              children: [
                ...
                BlocListener<ChatBloc, ChatState>(
                  listener: (context, chatState) {
                    if (!isDesktop) {
                      ...
                      if (!_isChatOpen &&
                          currentCount > _lastSeenMessageCount) {
                  ...
                  child: BlocConsumer<GameBloc, GameState>(
                    ...
                    builder: (context, state) {
                      ...
                      // ============================================================
                      final bool isInMarkingPhase = state is MarkingState ||
                          state is OpponentMarkingState;
                      final lastMove =
                      ...
                      final bool guessMissed = lastGuessPosition != null &&
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                padding:
                                                    const EdgeInsets.symmetric(
                                                        vertical: 4),
                                                child: state is GameActiveState &&
                                                        state
                                                            .isLocalPlayerTurn &&
                                                        state
                                                            is! OpponentRevealingState &&
                ...
                if (!isDesktop)
                  DraggableChatPanel(
                      isOpen: _isChatOpen, onToggle: _toggleChat),
              ],
            );
          },
        ),
